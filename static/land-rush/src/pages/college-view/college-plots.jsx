...
const CollegePlots = () => {
  ...
  return (
    <div className="college-plots-list">
      {plots.map((plot) => (
        <div key={plot.id} className="plot-bar">
          <img src={plot.thumbnail} alt="Plot Thumbnail" className="plot-bar-thumbnail" />
          <div className="plot-bar-details">
